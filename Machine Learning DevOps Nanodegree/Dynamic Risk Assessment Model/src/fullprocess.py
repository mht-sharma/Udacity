...
print('Deployment completed. Reporting the results...')
subprocess.run('python reporting.py', shell=True, check=False)
subprocess.run('python apicalls.py', shell=True, check=False)
