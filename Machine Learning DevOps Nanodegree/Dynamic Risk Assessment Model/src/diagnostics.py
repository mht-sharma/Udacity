...
def dataframe_summary():
    ...
    ] + result.values.tolist()  # return value should be a list containing all summary statistics
...
def execution_time():
    ...
    train_time = (
        timeit.timeit("training.train_model", setup="import training", number=num_runs)
        / num_runs
    )
...
if __name__ == "__main__":
    ...
    miss_data = missing_data_stats()
    print(f"Missing data : {miss_data}")
